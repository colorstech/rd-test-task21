...
public class CpeMatch__1 {
    ...
    public String toString() {
        ...
        sb.append(CpeMatch__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
