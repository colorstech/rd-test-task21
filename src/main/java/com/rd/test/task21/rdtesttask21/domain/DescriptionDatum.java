...
public class DescriptionDatum {
    ...
    public String toString() {
        ...
        sb.append(DescriptionDatum.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lang");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DescriptionDatum) == false) {
            return false;
        }
        DescriptionDatum rhs = ((DescriptionDatum) other);
