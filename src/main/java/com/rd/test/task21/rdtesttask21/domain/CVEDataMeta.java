...
public class CVEDataMeta {
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.assigner == rhs.assigner)||((this.assigner!= null)&&this.assigner.equals(rhs.assigner)))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
